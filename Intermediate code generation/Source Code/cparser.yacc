...
codegen()
 ...
 strcpy(temp1,"t");
 strcat(temp1,i_);
  printf("%s = %s %s %s\n",temp1,st[top-2],st[top-1],st[top]);
  top-=2;
 strcpy(st[top],temp1);
 i_[0]++;
 }
...
primary_expression
	: IDENTIFIER	{push(tempid);context_check();$$ = addnew(myconst,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}//$$ = addnew("IDENTIFIER PRIMARY Expression",NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
	| CONSTANT	{push(myconst);$$ = addnew(myconst,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
...
multiplicative_expression
	...
	| multiplicative_expression '*'{push("*");} cast_expression	{$$ = addnew("* MULTIPLICATIVE Expression",$1,$4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);codegen();}
	| multiplicative_expression '/'{push("/");} cast_expression	{$$ = addnew("/ MULTIPLICATIVE Expression",$1,$4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);codegen();}
	| multiplicative_expression '%'{push("%");} cast_expression	{$$ = addnew("% MULTIPLICATIVE Expression",$1,$4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);codegen();}
	;
...
additive_expression
	...
	| additive_expression '+'{push("+");} multiplicative_expression	{$$ = addnew("+ ADDITIVE Expression",$1,$4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);codegen();}
	| additive_expression '-'{push("-");} multiplicative_expression	{$$ = addnew("- ADDITIVE Expression",$1,$4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);codegen();}
	;
...
assignment_expression
	...
	| unary_expression assignment_operator assignment_expression	{if($1!=$3){type_err($1,$3);}$$ = addnew("ASSIGNMENT Expression",$1,$2,$3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);codegen_assign();}
	;

assignment_operator
	: '='	{push("=");$$ = addnew("ASSIGNMENT Operator",NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
...
expression_statement
	: ';'	{lab1();$$ = addnew("EXPRESSION STATEMENT",NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
...
iteration_statement
	...
	| FOR '(' expression_statement expression_statement {lab2();} expression{lab3();} ')' statement	{lab4();$$ = addnew("FOR ITRATION STATEMENT",$3,$4,$6,$9,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
	;
